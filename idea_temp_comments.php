...
$args = array( 'post_type' => 'ideas', 'user_id' => $current_id );
...
<div class="sabai-questions-answers">
   ...
   <div class="sabai-entity sabai-entity-type-content sabai-entity-bundle-name-questions-answers sabai-entity-bundle-type-questions-answers sabai-entity-mode-summary sabai-questions-accepted sabai-clearfix" id="sabai-entity-content-107">
    <div class="sabai-row">
        <div class="sabai-col-xs-2 sabai-questions-side">
            <div class="sabai-questions-vote-count">
                <span class="sabai-number"><?php echo wp_count_comments($comment->comment_post_ID)->total_comments; ?> <i  style="color: #BBBBBB;" class="fa fa-comments"></i></span> <?php __('comments', 'marylink-custom-plugin'); ?>            </div>
        </div>
        <div class="sabai-col-xs-10 sabai-questions-main">
            <div class="sabai-questions-title">
                <i title="This answer has been accepted." class="sabai-entity-icon-questions-resolved fa fa-check-circle"></i> In reply to: <a class=" sabai-entity-permalink sabai-entity-id-107 sabai-entity-type-content sabai-entity-bundle-name-questions-answers sabai-entity-bundle-type-questions-answers" title="Comment réduire les photos &quot;couvertures&quot; de profil ?" href="<?php echo get_permalink($comment->comment_post_ID); ?>"><?php
